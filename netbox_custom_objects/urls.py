...
urlpatterns = [
    ...
    path('custom_object_types/<int:pk>/', include(get_model_urls(APP_LABEL, 'customobjecttype'))),
    ...
    path('custom_objects/<int:pk>/', include(get_model_urls(APP_LABEL, 'customobject'))),

    path('custom_object_type_fields/<int:pk>/', include(get_model_urls(APP_LABEL, 'customobjecttypefield'))),
    ...
    path('<str:custom_object_type>/<int:pk>/', include(get_model_urls(APP_LABEL, 'customobject'))),
]
