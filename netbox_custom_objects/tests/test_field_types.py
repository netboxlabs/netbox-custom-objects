...
class TextFieldTypeTestCase(FieldTypeTestCase):
    ...
    def test_text_field_model_generation(self):
        ...
        field = self.create_custom_object_type_field(
            self.custom_object_type, name='description', label='Description', type='text', required=True
        )
...
class LongTextFieldTypeTestCase(FieldTypeTestCase):
    ...
    def test_long_text_field_creation(self):
        ...
        field = self.create_custom_object_type_field(
            self.custom_object_type, name='content', label='Content', type='longtext', required=True
        )
    ...
    def test_long_text_field_model_generation(self):
        ...
        field = self.create_custom_object_type_field(
            self.custom_object_type, name='content', label='Content', type='longtext'
        )
        field  # To silence ruff error
...
class IntegerFieldTypeTestCase(FieldTypeTestCase):
    ...
    def test_integer_field_model_generation(self):
        ...
        field = self.create_custom_object_type_field(
            self.custom_object_type, name='count', label='Count', type='integer', default=10
        )
        field  # To silence ruff error
...
class DecimalFieldTypeTestCase(FieldTypeTestCase):
    ...
    def test_decimal_field_model_generation(self):
        ...
        field = self.create_custom_object_type_field(
            self.custom_object_type, name='price', label='Price', type='decimal', default=10.50
        )
        field  # To silence ruff error
...
class BooleanFieldTypeTestCase(FieldTypeTestCase):
    ...
    def test_boolean_field_creation(self):
        ...
        field = self.create_custom_object_type_field(
            self.custom_object_type, name='active', label='Active', type='boolean', default=True
        )
    ...
    def test_boolean_field_validation(self):
        ...
        field = self.create_custom_object_type_field(
            self.custom_object_type, name='active', label='Active', type='boolean'
        )
...
class DateFieldTypeTestCase(FieldTypeTestCase):
    ...
    def test_date_field_creation(self):
        ...
        field = self.create_custom_object_type_field(
            self.custom_object_type, name='created_date', label='Created Date', type='date', default='2023-01-01'
        )
    ...
    def test_date_field_validation(self):
        ...
        field = self.create_custom_object_type_field(
            self.custom_object_type, name='created_date', label='Created Date', type='date'
        )
...
class DateTimeFieldTypeTestCase(FieldTypeTestCase):
    ...
    def test_datetime_field_validation(self):
        ...
        field = self.create_custom_object_type_field(
            self.custom_object_type, name='created_datetime', label='Created DateTime', type='datetime'
        )
...
class URLFieldTypeTestCase(FieldTypeTestCase):
    ...
    def test_url_field_creation(self):
        ...
        field = self.create_custom_object_type_field(
            self.custom_object_type, name='website', label='Website', type='url', validation_regex='^https://.*'
        )
    ...
    def test_url_field_model_generation(self):
        ...
        field = self.create_custom_object_type_field(
            self.custom_object_type, name='website', label='Website', type='url'
        )
        field  # To silence ruff error
...
class JSONFieldTypeTestCase(FieldTypeTestCase):
    ...
    def test_json_field_creation(self):
        ...
        field = self.create_custom_object_type_field(
            self.custom_object_type, name='metadata', label='Metadata', type='json', default={'key': 'value'}
        )
    ...
    def test_json_field_model_generation(self):
        ...
        field = self.create_custom_object_type_field(
            self.custom_object_type, name='metadata', label='Metadata', type='json'
        )
        field  # To silence ruff error
...
class SelectFieldTypeTestCase(FieldTypeTestCase):
    ...
    def test_select_field_validation(self):
        ...
        field = self.create_custom_object_type_field(
            self.custom_object_type, name='status', label='Status', type='select', choice_set=self.choice_set
        )
...
class MultiSelectFieldTypeTestCase(FieldTypeTestCase):
    ...
    def test_multiselect_field_validation(self):
        ...
        field = self.create_custom_object_type_field(
            self.custom_object_type, name='tags', label='Tags', type='multiselect', choice_set=self.choice_set
        )
...
class ObjectFieldTypeTestCase(FieldTypeTestCase):
    ...
    def test_object_field_model_generation(self):
        ...
        try:
            ...
            device = Device.objects.create(name='Test Device', site=site, device_type=device_type, role=device_role)
...
class MultiObjectFieldTypeTestCase(FieldTypeTestCase):
    ...
    def test_multiobject_field_model_generation(self):
        ...
        try:
            ...
            device_type = DeviceType.objects.create(manufacturer=manufacturer, model='Test Model', slug='test-model')
            device_role = DeviceRole.objects.create(name='Test Role', slug='test-role')
            device1 = Device.objects.create(name='Test Device 1', site=site, device_type=device_type, role=device_role)
            device2 = Device.objects.create(name='Test Device 2', site=site, device_type=device_type, role=device_role)
...
class CrossReferentialFieldTestCase(FieldTypeTestCase):
    ...
    def test_cross_referential_object_field(self):
        ...
        self.create_custom_object_type_field(
            second_type, name='name', label='Name', type='text', primary=True, required=True
        )
