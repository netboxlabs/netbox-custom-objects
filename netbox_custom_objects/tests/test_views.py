...
class CustomObjectViewTestCase(CustomObjectsTestCase, ViewTestCases.PrimaryObjectViewTestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.instance1 = cls.model.objects.create(name='Test Instance 1', description='First test instance', count=10)

        cls.instance2 = cls.model.objects.create(name='Test Instance 2', description='Second test instance', count=20)
...
class ComplexCustomObjectViewTestCase(CustomObjectsTestCase, ViewTestCases.PrimaryObjectViewTestCase):
    ...
    def setUpTestData(cls):
        ...
        CustomObjectTypeField.objects.create(
            custom_object_type=cls.custom_object_type, name='active', label='Active', type='boolean', default=True
        )
    ...
    def setUpTestData(cls):
        ...
        try:
            ...
            cls.device = Device.objects.create(
                name='Test Device', site=cls.site, device_type=device_type, role=device_role
            )

            # Create custom object instances
            cls.instance_1 = cls.model.objects.create(name='Object Test Instance 1', device=cls.device)
            cls.instance_1.sites.add(cls.site)

            cls.instance_2 = cls.model.objects.create(name='Object Test Instance 2', device=cls.device)
